<div class="lg:px-32 px-4 lg:mt-72 mt-48 flex flex-wrap items-center justify-between">
    <div class="lg:w-5/12 w-full lg:-mt-28 -mt-0">
        <div class="">
            <h1 class="text-red text-8xl font-bold japan-font">02</h1>
            <h1 class=" text-5xl text-white font-bold">ADD COLORS</h1>
        </div>
        <p class="text-gray-300 text-lg mt-6">
            Colored tattoos are done using different ink colors. With mixing the colors to achieve the proper shade and
            tone, considering the tattoo design and what you want it to look like. Some of the most prevalent ink colors
            used for colored tattoos are red, blue, green, yellow, brown; this also comprises darker or lighter shades
            of these colors.
            Getting colored tattoos is simply more fun, artistic and interesting, compared to a simple black & grey
            design.
            Color helps a tattoo stand out, which is generally the very aim of a tattoo in the first place.
        </p>
    </div>
